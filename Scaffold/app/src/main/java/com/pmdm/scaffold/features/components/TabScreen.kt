...
fun NavigationBarJoel(){
    NavigationBar(
        ...
        NavigationBarItem(
            icon = {
                Icon(
                    painterResource(com.pmdm.scaffold.R.drawable.groups_24px),
        ...
        NavigationBarItem(
            icon = {
                Icon(
                    painterResource(com.pmdm.scaffold.R.drawable.factory_24px),
...
fun NavigationBarScreen() {
    ...
    Scaffold(
        ...
        Column(
            ...
            Image(
                painter = painterResource(com.pmdm.scaffold.R.drawable.fabrica),
